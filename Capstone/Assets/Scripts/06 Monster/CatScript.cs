...
public class CatScript : MonsterScript
{
    ...
    private readonly int hashHit = Animator.StringToHash("IsHit");  // 공격
    private readonly int hashPatrol = Animator.StringToHash("IsPatrol");   // 플레이어가 죽었을 때 patrol 
