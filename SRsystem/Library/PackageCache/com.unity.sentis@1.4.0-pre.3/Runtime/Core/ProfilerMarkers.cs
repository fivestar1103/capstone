...
{
    public static readonly ProfilerMarker Execute = new ProfilerMarker("Sentis.Execute");
    ...
    public static readonly ProfilerMarker InferModelSymbolicTensors = new ProfilerMarker("Sentis.Compiler.Analyser.ShapeInferenceAnalysis.InferModelSymbolicTensors");
